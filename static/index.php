...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="col-md-12" style="background-color:#ffffff;padding-left: 15%;padding-right: 15%;padding-bottom: 2%;font-size:12px;">
    ...
    <div class="col-md-12" style="padding-bottom: 6%;padding-top: 6%;" id="categoria">
      ...
      <div class="col-lg-3 col-sm-4 col-xs-6"><div class="categorias"><a title="Image 1" href="/categoria/?cat=boundaries"><img class="thumbnail img-responsive" src="{% static 'images/iconos/Icono02_fronteras.png' %}" style="width:100%;"></a>
      ...
      <div class="col-lg-3 col-sm-4 col-xs-6"><div class="categorias"><a title="Image 1" href="/categoria/?cat=health"><img class="thumbnail img-responsive" src="{% static 'images/iconos/iconos09_salud.png' %}" style="width:100%;"></a>
      ...
      <div class="col-lg-3 col-sm-4 col-xs-6"><div class="categorias"><a title="Image 1" href="/categoria/?cat=economy"><img class="thumbnail img-responsive" src="{% static 'images/iconos/iconos04_economia.png' %}" style="width:100%;"></a>
      ...
      <div class="col-lg-3 col-sm-4 col-xs-6"><div class="categorias"><a title="Image 1" href="/categoria/?cat=elevation"><img class="thumbnail img-responsive" src="{% static 'images/iconos/iconos05_elevacion.png' %}" style="width:100%;"></a>
      ...
      <div class="col-lg-3 col-sm-4 col-xs-6"><div class="categorias"><a title="Image 1" href="/categoria/?cat=environment"><img class="thumbnail img-responsive" src="{% static 'images/iconos/iconos06_mediambiente.png' %}" style="width:100%;"></a>
      ...
      <div class="col-lg-3 col-sm-4 col-xs-6"><div class="categorias"><a title="Image 1" href="/categoria/?cat=farming"><img class="thumbnail img-responsive" src="{% static 'images/iconos/iconos07_agri.png' %}" style="width:100%;"></a>
      ...
      <div class="col-lg-3 col-sm-4 col-xs-6"><div class="categorias"><a title="Image 1" href="#"><img class="thumbnail img-responsive" src="{% static 'images/iconos/iconos08_informacion.png' %}" style="width:100%;"></a>
      ...
      <div class="col-lg-3 col-sm-4 col-xs-6"><div class="categorias"><a title="Image 1" href="/categoria/?cat=ClimatologyMeteorologyAtmosphera"><img class="thumbnail img-responsive" src="{% static 'images/iconos/iconos03_meteorolo.png' %}" style="width:100%;"></a>
      ...
      <div class="col-lg-3 col-sm-4 col-xs-6"><div class="categorias"><a title="Image 1" href="#"><img class="thumbnail img-responsive" src="{% static 'images/iconos/iconos10_imagesatelital.png' %}" style="width:100%;"></a>
      ...
      <div class="col-lg-3 col-sm-4 col-xs-6"><div class="categorias"><a title="Image 1" href="/categoria/?cat=oceans"><img class="thumbnail img-responsive" src="{% static 'images/iconos/iconos10_imagesatelital.png' %}" style="width:100%;"></a>
      ...
      <div class="col-lg-3 col-sm-4 col-xs-6"><div class="categorias"><a title="Image 1" href="#"><img class="thumbnail img-responsive" src="{% static 'images/iconos/iconos12_intmilitar.png' %}" style="width:100%;"></a>
      ...
      <div class="col-lg-3 col-sm-4 col-xs-6"><div class="categorias"><a title="Image 1" href="/categoria/?cat=location"><img class="thumbnail img-responsive" src="{% static 'images/iconos/iconos13_localizacion.png' %}" style="width:100%;"></a>
      ...
      <div class="col-lg-3 col-sm-4 col-xs-6"><div class="categorias"><a title="Image 1" href="/categoria/?cat=oceans"><img class="thumbnail img-responsive" src="{% static 'images/iconos/iconos14_oceanos.png' %}" style="width:100%;"></a>
      ...
      <div class="col-lg-3 col-sm-4 col-xs-6"><div class="categorias"><a title="Image 1" href="/categoria/?cat=biota"><img class="thumbnail img-responsive" src="{% static 'images/iconos/iconos20_biota.png' %}" style="width:100%;"></a>
      ...
      <div class="col-lg-3 col-sm-4 col-xs-6"><div class="categorias"><a title="Image 1" href="/categoria/?cat=society"><img class="thumbnail img-responsive" src="{% static 'images/iconos/iconos16_sociedad.png' %}" style="width:100%;"></a>
      ...
      <div class="col-lg-3 col-sm-4 col-xs-6"><div class="categorias"><a title="Image 1" href="/categoria/?cat=structure"><img class="thumbnail img-responsive" src="{% static 'images/iconos/iconos17_infraestructura.png' %}" style="width:100%;"></a>
      ...
      <div class="col-lg-3 col-sm-4 col-xs-6"><div class="categorias"><a title="Image 1" href="/categoria/?cat=transportation"><img class="thumbnail img-responsive" src="{% static 'images/iconos/iconos18_transporte.png' %}" style="width:100%;"></a>
      ...
      <div class="col-lg-3 col-sm-4 col-xs-6"><div class="categorias"><a title="Image 1" href="/categoria/?cat=utilitiesCommunication"><img class="thumbnail img-responsive" src="{% static 'images/iconos/iconos19_telecomunicaciones.png' %}" style="width:100%;"></a>
      ...
      <div class="col-lg-3 col-sm-4 col-xs-6"><div class="categorias"><a title="Image 1" href="/categoria/?cat=planningCadastre"><img class="thumbnail img-responsive" src="{% static 'images/iconos/iconos15_planificacioncatastros.png' %}" style="width:100%;"></a>
